...
const env: Env = {
  ...
  SHOW_DEBUG_MESSAGES: JSON.parse(process.env.REACT_APP_SHOW_DEBUG_MESSAGES!),
  ADDITIONAL_LIMBER_API_LATENCY_MS: JSON.parse(process.env.REACT_APP_ADDITIONAL_LIMBER_API_LATENCY_MS!),
