...
internal sealed class MergeType {
  internal data class Merge @JsonCreator(mode = JsonCreator.Mode.DELEGATING) constructor(
    @JsonValue val value: ObjectNode,
  ) : MergeType()

  internal data object Remove : MergeType()

  internal data class Replace @JsonCreator(mode = JsonCreator.Mode.DELEGATING) constructor(
    @JsonValue val value: ObjectNode,
  ) : MergeType()
}
