...
internal class UpdateFormTemplateQuestionTest : ResourceTest() {
    ...
    fun formTemplateDoesNotExist() {
        ...
        piperTest.test(
            ...
            pathParams = mapOf(
                ...
                UpdateFormTemplateQuestion.partId to partId,
                UpdateFormTemplateQuestion.questionGroupId to questionGroupId,
    ...
    fun formTemplateQuestionGroupDoesNotExist() {
        ...
        piperTest.test(
            ...
            pathParams = mapOf(
                UpdateFormTemplateQuestion.formTemplateId to formTemplateRep.id,
                UpdateFormTemplateQuestion.partId to formTemplateRep.parts.single().id,
                UpdateFormTemplateQuestion.questionGroupId to questionGroupId,
                UpdateFormTemplateQuestion.questionId to questionId
            ),
            body = formTemplateQuestionUpdateRep,
    ...
    fun formTemplateQuestionDoesNotExist() {
        ...
        piperTest.test(
            ...
            pathParams = mapOf(
                UpdateFormTemplateQuestion.formTemplateId to formTemplateRep.id,
                UpdateFormTemplateQuestion.partId to formTemplateRep.parts.single().id,
                UpdateFormTemplateQuestion.questionGroupId to formTemplateRep.parts.single().questionGroups.single().id,
                UpdateFormTemplateQuestion.questionId to questionId
            ),
            body = formTemplateQuestionUpdateRep,
    ...
    fun happyPath() {
        ...
        var formTemplateQuestionRep = FormTemplateQuestionRepFixtures[0].complete(this, 6)
        ...
        formTemplateRep = formTemplateRep.copy(
            parts = listOf(with(formTemplateRep.parts.single()) part@{
                this@part.copy(
                    questionGroups = listOf(with(this@part.questionGroups.single()) questionGroup@{
                        this@questionGroup.copy(
                            questions = this@questionGroup.questions.map {
