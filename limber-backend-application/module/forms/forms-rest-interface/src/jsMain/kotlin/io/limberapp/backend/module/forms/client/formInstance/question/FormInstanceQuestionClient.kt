...
interface FormInstanceQuestionClient {
  suspend operator fun invoke(endpoint: FormInstanceQuestionApi.Put): Result<FormInstanceQuestionRep.Complete>

  suspend operator fun invoke(endpoint: FormInstanceQuestionApi.Delete): Result<Unit>
}
