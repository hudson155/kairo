...
class CannotDeleteRequiredQuestion : ConflictException(
    ...
    developerMessage = "This exception should be thrown when an attempt is made to delete a form instance question" +
        " for which the corresponding form template question is required.")
