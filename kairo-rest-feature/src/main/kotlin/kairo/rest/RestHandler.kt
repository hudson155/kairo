 ...
 */
public abstract class RestHandler<Endpoint : RestEndpoint<*, Response>, Response : Any?> {
  internal val endpoint: KClass<Endpoint> = typeParam(RestHandler::class, 0, this::class)

  internal val template: RestEndpointTemplate = RestEndpointTemplate.from(endpoint)
  internal val reader: RestEndpointReader<Endpoint> = RestEndpointReader.from(endpoint)
  ...
  public abstract suspend fun handle(endpoint: Endpoint): Response
