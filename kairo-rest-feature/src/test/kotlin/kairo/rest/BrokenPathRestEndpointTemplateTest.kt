...
internal class BrokenPathRestEndpointTemplateTest {
  ...
  fun missingMethod(): Unit = runTest {
    shouldThrow<IllegalArgumentException> {
      ...
      "REST endpoint kairo.rest.BrokenPathLibraryBookApi.MissingPath" +
        " is missing @Path.",
    )
  }
  ...
  fun emptyMethod(): Unit = runTest {
    shouldThrow<IllegalArgumentException> {
      ...
      "REST endpoint kairo.rest.BrokenPathLibraryBookApi.EmptyPath" +
  ...
  fun malformedConstantPathComponent(): Unit = runTest {
    shouldThrow<IllegalArgumentException> {
      ...
      "REST endpoint kairo.rest.BrokenPathLibraryBookApi.MalformedConstantPathComponent" +
  ...
  fun malformedParamPathComponent(): Unit = runTest {
    shouldThrow<IllegalArgumentException> {
      ...
      "REST endpoint kairo.rest.BrokenPathLibraryBookApi.MalformedParamPathComponent" +
  ...
  fun nullablePathParam(): Unit = runTest {
    shouldThrow<IllegalArgumentException> {
      ...
      "REST endpoint kairo.rest.BrokenPathLibraryBookApi.NullablePathParam" +
  ...
  fun optionalPathParam(): Unit = runTest {
    shouldThrow<IllegalArgumentException> {
      ...
      "REST endpoint kairo.rest.BrokenPathLibraryBookApi.OptionalPathParam" +
  ...
  fun duplicatePathParamInPath(): Unit = runTest {
    shouldThrow<IllegalArgumentException> {
      ...
      "REST endpoint kairo.rest.BrokenPathLibraryBookApi.DuplicatePathParamInPath" +
  ...
  fun pathParamInPathButNotInConstructor(): Unit = runTest {
    shouldThrow<IllegalArgumentException> {
      ...
      "REST endpoint kairo.rest.BrokenPathLibraryBookApi.PathParamInPathButNotInConstructor" +
  ...
  fun pathParamInConstructorButNotInPath(): Unit = runTest {
    shouldThrow<IllegalArgumentException> {
      ...
      "REST endpoint kairo.rest.BrokenPathLibraryBookApi.PathParamInConstructorButNotInPath" +
