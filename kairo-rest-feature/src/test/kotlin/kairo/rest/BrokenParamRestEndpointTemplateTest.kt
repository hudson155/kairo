...
internal class BrokenParamRestEndpointTemplateTest {
  ...
  fun nonParamConstructorParameter(): Unit = runTest {
    shouldThrow<IllegalArgumentException> {
      ...
      "REST endpoint kairo.rest.BrokenParamLibraryBookApi.NonParamConstructorParameter" +
  ...
  fun bodyAsPathParam(): Unit = runTest {
    shouldThrow<IllegalArgumentException> {
      ...
      "REST endpoint kairo.rest.BrokenParamLibraryBookApi.BodyAsPathParam" +
  ...
  fun bodyAsQueryParam(): Unit = runTest {
    shouldThrow<IllegalArgumentException> {
      ...
      "REST endpoint kairo.rest.BrokenParamLibraryBookApi.BodyAsQueryParam" +
        " body cannot be param.",
    )
  }
  ...
  fun pathParamMarkedAsQueryParam(): Unit = runTest {
    shouldThrow<IllegalArgumentException> {
      ...
      "REST endpoint kairo.rest.BrokenParamLibraryBookApi.PathParamMarkedAsQueryParam" +
  ...
  fun queryParamMarkedAsPathParam(): Unit = runTest {
    shouldThrow<IllegalArgumentException> {
      ...
      "REST endpoint kairo.rest.BrokenParamLibraryBookApi.QueryParamMarkedAsPathParam" +
  ...
  fun paramIsPathAndQuery(): Unit = runTest {
    shouldThrow<IllegalArgumentException> {
      ...
      "REST endpoint kairo.rest.BrokenParamLibraryBookApi.ParamIsPathAndQuery" +
  ...
  fun nullablePathParam(): Unit = runTest {
    shouldThrow<IllegalArgumentException> {
      ...
      "REST endpoint kairo.rest.BrokenParamLibraryBookApi.NullablePathParam" +
  ...
  fun optionalPathParam(): Unit = runTest {
    shouldThrow<IllegalArgumentException> {
      ...
      "REST endpoint kairo.rest.BrokenParamLibraryBookApi.OptionalPathParam" +
  ...
  fun optionalQueryParam(): Unit = runTest {
    shouldThrow<IllegalArgumentException> {
      ...
      "REST endpoint kairo.rest.BrokenParamLibraryBookApi.OptionalQueryParam" +
