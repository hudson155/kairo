...
internal class InstantDefaultObjectMapperTest {
  ...
  fun `deserialize, missing leading zero from year`(): Unit = runTest {
    serializationShouldFail {
      mapper.kairoRead<MyClass>("{ \"value\": \"1-02-03T19:44:32.123456789Z\" }")
    }
  }
  ...
  fun `deserialize, missing leading zero from month`(): Unit = runTest {
    serializationShouldFail {
      mapper.kairoRead<MyClass>("{ \"value\": \"2023-2-03T19:44:32.123456789Z\" }")
    }
  }
  ...
  fun `deserialize, missing leading zero from day`(): Unit = runTest {
    serializationShouldFail {
      mapper.kairoRead<MyClass>("{ \"value\": \"2023-02-3T19:44:32.123456789Z\" }")
    }
  }
  ...
  fun `deserialize, missing leading zero from hour`(): Unit = runTest {
    serializationShouldFail {
      mapper.kairoRead<MyClass>("{ \"value\": \"2023-02-03T9:44:32.123456789Z\" }")
    }
  }
  ...
  fun `deserialize, missing leading zero from minute`(): Unit = runTest {
    serializationShouldFail {
      mapper.kairoRead<MyClass>("{ \"value\": \"2023-02-03T19:4:32.123456789Z\" }")
    }
  }
  ...
  fun `deserialize, missing leading zero from second`(): Unit = runTest {
    serializationShouldFail {
      mapper.kairoRead<MyClass>("{ \"value\": \"2023-02-03T19:44:2.123456789Z\" }")
    }
  }
  ...
  fun `deserialize, nonexistent date (low month)`(): Unit = runTest {
    serializationShouldFail {
      mapper.kairoRead<MyClass>("{ \"value\": \"2023-00-03T19:44:32.123456789Z\" }")
    }
  }
  ...
  fun `deserialize, nonexistent date (high month)`(): Unit = runTest {
    serializationShouldFail {
      mapper.kairoRead<MyClass>("{ \"value\": \"2023-13-03T19:44:32.123456789Z\" }")
    }
  }
  ...
  fun `deserialize, nonexistent date (low day)`(): Unit = runTest {
    serializationShouldFail {
      mapper.kairoRead<MyClass>("{ \"value\": \"2023-02-00T19:44:32.123456789Z\" }")
    }
  }
  ...
  fun `deserialize, nonexistent date (high day)`(): Unit = runTest {
    serializationShouldFail {
      mapper.kairoRead<MyClass>("{ \"value\": \"2023-02-29T19:44:32.123456789Z\" }")
    }
  }
  ...
  fun `deserialize, nonexistent date (high hour)`(): Unit = runTest {
    serializationShouldFail {
      mapper.kairoRead<MyClass>("{ \"value\": \"2023-02-03T24:44:32.123456789Z\" }")
    }
  }
  ...
  fun `deserialize, nonexistent date (high minute)`(): Unit = runTest {
    serializationShouldFail {
      mapper.kairoRead<MyClass>("{ \"value\": \"2023-02-03T19:60:32.123456789Z\" }")
    }
  }
  ...
  fun `deserialize, nonexistent date (high second)`(): Unit = runTest {
    serializationShouldFail {
      mapper.kairoRead<MyClass>("{ \"value\": \"2023-02-03T19:44:60.123456789Z\" }")
    }
  }
  ...
  fun `deserialize, too much precision`(): Unit = runTest {
    serializationShouldFail {
      mapper.kairoRead<MyClass>("{ \"value\": \"2023-02-03T19:44:32.1234567890Z\" }")
    }
  }
  ...
  fun `deserialize, no time zone`(): Unit = runTest {
    serializationShouldFail {
      mapper.kairoRead<MyClass>("{ \"value\": \"2023-02-03T19:44:32.123456789\" }")
    }
  }

  @Test
  fun `deserialize, non-UTC`(): Unit = runTest {
    mapper.kairoRead<MyClass>("{ \"value\": \"2023-02-03T19:44:32.123456789-07:00[America/Edmonton]\" }")
    MyClass(Instant.parse("2023-02-04T02:44:32.123456789Z"))
  }

  @Test
  fun `deserialize, wrong type, number`(): Unit = runTest {
    serializationShouldFail {
      mapper.kairoRead<MyClass>("{ \"value\": 1699904672123 }")
    }
  }
}
